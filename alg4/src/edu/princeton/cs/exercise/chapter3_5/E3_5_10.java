...
/**
 * 3.5.10 Modify RedBlackBST to keep duplicate keys in the tree. Return any value
 * associated with the given key for get(), and remove all nodes in the tree that have
 * keys equal to the given key for delete().
 * <p>
 * 修改 RedBlackBST 来保存树里的重复键.get() 返回任意给定 key 关联的值,delete()删除所有给定 key 关联的值
 *
 * @author LeonChen
 * @since 9/7/21
 */
class E3_5_10 {
    ...
    public static void main(String[] args) {
        RedBlackBSTDuplicateKeys<Integer, Integer> redBlackBSTDuplicateKeys = new RedBlackBSTDuplicateKeys<>();
     ...
     */
    private static class RedBlackBSTDuplicateKeys<Key extends Comparable<Key>, Value> {
