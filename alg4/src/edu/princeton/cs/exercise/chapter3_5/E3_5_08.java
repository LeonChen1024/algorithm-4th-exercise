 ...
 * value associated with the given key for get(), and remove all items in the table that
 * have keys equal to the given key for delete().
 * <p>
 * 修改 LinearProbingHashST 来保存表中的重复键.get()返回给定 key关联的任意值,delete() 删除所有表中
 * 关联给定 key 的值
 *
 * @author LeonChen
 * @since 9/6/21
...
class E3_5_08 {
    ...
    public static void main(String[] args) {
        LinearProbingHashTableDuplicateKeys<Integer, Integer> linearProbingHashTableDuplicateKeys =
                new LinearProbingHashTableDuplicateKeys<>(10);
    ...
    private static class LinearProbingHashTableDuplicateKeys<Key, Value> {
