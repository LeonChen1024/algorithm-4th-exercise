...
/**
 * 3.5.11 Develop a MultiSET class that is like SET, but allows equal keys and thus
 * implements a mathematical multiset.
 * <p>
 * 开发一个类似SET的 MultiSET 类,但是允许 相同的键并且实现一个数学多集
 *
 * @author LeonChen
 * @since 9/8/21
 */
