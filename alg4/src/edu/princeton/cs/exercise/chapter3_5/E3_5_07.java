 ...
 * <p>
 * 开发类 SETint 和 SETdouble 来分别维护key 为原始 int 和 double 类型的有序集合.(如同练习 3.5.5 中
 * 那样忽略值)
 *
 * @author LeonChen
 * @since 9/6/21
...
class E3_5_07 {
    ...
    private static class SETdouble {
    ...
    private static void testSETint() {
    ...
    private static void testSETdouble() {
        StdOut.println("\nSETdouble test");
