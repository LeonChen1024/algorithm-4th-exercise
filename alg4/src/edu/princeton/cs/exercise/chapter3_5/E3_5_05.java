...
/**
 * 3.5.5 Develop classes STint and STdouble for maintaining ordered symbol tables where
 * keys are primitive int and double types, respectively. (Convert generics to
 * primitive types in the code of RedBlackBST.) Test your solution with a version of
 * SparseVector as a client.
 * <p>
 * 开发类 STint and STdouble 来维护有序符号表,其中 key 分别是原始类型 int 和 double.(将 RedBlackBST
 * 中的类型转为原始类型)使用一个 SparseVector 测试你的方案
 *
 * @author LeonChen
 * @since 9/5/21
 */
class E3_5_05 {
    ...
    private static class SparseVectorIntKeys {
    ...
    private static class SparseVectorDoubleKeys {
    ...
    private static void testSTdouble() {
        //Matrix
        // 0  .90    0    0    0
        // 0    0  .36  .36  .18
        // 0    0    0  .90    0
