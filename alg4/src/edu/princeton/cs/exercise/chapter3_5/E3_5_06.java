 ...
 * <p>
 * 开发类 HashSETint 和 HashSETdouble 来分别维护键是原始类型 int 和 double 的 set.(如同练习 3.5.4
 * 那样忽略值)
 *
 * @author LeonChen
 * @since 9/5/21
...
class E3_5_06 {
    ...
    private static class HashSETdouble {
        private int keysSize;
        private int size;
        private double[] keys;
    ...
    private static void testHashSTint() {
    ...
    private static void testHashSTdouble() {
        StdOut.println("\n\nHashSTdouble test");
