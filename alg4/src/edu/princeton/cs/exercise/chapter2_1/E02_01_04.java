...
/**
 * 2.1.4 Show, in the style of the example trace with Algorithm 2.2, how insertion sort sorts the
 * array E A S Y Q U E S T I O N .
 *
 * <p>展示出如同 Algorithm 2.2 中追踪示例的样式表示插入排序如何排序数组E A S Y Q U E S T I O N
 *
 * @author LeonChen
 * @since 5/13/20
 */
