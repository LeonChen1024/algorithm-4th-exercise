 ...
 * <p>
 * 绘制树.添加一个 draw() 到 RedBlackBST 中绘制出如同正文中的红黑树图像(见练习 3.2.38)
 *
 * @author LeonChen
 * @since 7/3/21
 */
class E3_3_31 {
    ...
    /**
     * @formatter:off
     * 横坐标通过 treeLevel 由左往右递增,纵坐标则依层级固定递减即可
     * @formatter:on
     */
    public static void main(String[] args) {
        StdDraw.setPenRadius(0.0025);

        DrawRBT<Integer, String> redBlackBSTDrawable = new DrawRBT();
    ...
    private static class DrawRBT<Key extends Comparable<Key>, Value>
