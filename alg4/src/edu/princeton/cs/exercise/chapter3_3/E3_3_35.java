...
/**
 * 3.3.35 2-3 trees. Write a program TwoThreeST.java that uses two node types to implement
 * 2-3 search trees directly.
 * <p>
 * 2-3 树.编写一个程序 TwoThreeST.java 使用两个节点类型来实现 2-3 搜索树
 *
 * @author LeonChen
 * @since 7/6/21
 */
class E3_3_35 {
    ...
    public static void main(String[] args) {
        ...
        TwoThreeST<Integer, Integer> twoThreeST = new TwoThreeST<>();
        twoThreeST.put(5, 5);
