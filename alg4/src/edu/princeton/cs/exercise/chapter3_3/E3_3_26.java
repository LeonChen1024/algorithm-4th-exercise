...
/**
 * 3.3.26 Single top-down pass. Develop a modified version of your solution to Exercise
 * 3.3.25 that does not use recursion. Complete all the work splitting and balancing
 * 4-nodes (and balancing 3-nodes) on the way down the tree, finishing with an insertion
 * at the bottom.
 * <p>
 * 单次自上而下通过.开发一个练习 3.3.25 解决方案不使用递归的修改版本.完成所有的分割和平衡 4-节点(和平衡
 * 3-节点)在从上往下处理树的时候,以在底部插入一个节点结束.
 *
 * @author LeonChen
 * @since 6/28/21
 */
class E3_3_26 {
    ...
    public static void main(String[] args) {
        ...
        RedBlackIterative234BST<Integer, Integer> redBlackIterative234BST = new RedBlackIterative234BST();
    ...
    private static class RedBlackIterative234BST<Key extends Comparable<Key>, Value> {
