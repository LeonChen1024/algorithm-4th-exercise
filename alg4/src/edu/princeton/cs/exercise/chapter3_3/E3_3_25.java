 ...
 * <p>
 * 自顶向下的 2-3-4 树.开发一个基础符号表API 实现使用平衡的 2-3-4 树作为底层数据结构,使用红黑树表示并且使用
 * 正文中描述的插入方法,其中 4-节点通过向下搜索时翻转颜色向上的时候平衡来分割
 *
 * @author LeonChen
 * @since 6/28/21
 */
class E3_3_25 {
    ...
    public static void main(String[] args) {
        ...
        RedBlackTopDown234BST<Integer, Integer> redBlackTopDown234BST = new RedBlackTopDown234BST<>();
