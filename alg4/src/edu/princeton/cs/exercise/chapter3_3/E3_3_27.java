 ...
 * <p>
 * 允许右倾红色链接.开发一个练习 3.3.25 允许红色链接在右边的修改版本.
 *
 * @author LeonChen
 * @since 6/29/21
 */
class E3_3_27 {
    ...
    public static void main(String[] args) {
        ...
        RedBlackTopDown234RightLeaningBST<Integer, Integer> redBlackTopDown234RightLeaningBST =
                new RedBlackTopDown234RightLeaningBST<>();
    ...
    private static class RedBlackTopDown234RightLeaningBST<Key extends Comparable<Key>, Value> extends E3_3_25.RedBlackTopDown234BST<Key, Value> {
