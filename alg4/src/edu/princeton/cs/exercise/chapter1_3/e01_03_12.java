 ...
 *
 * <p>编写一个 iterable Stack 客户端拥有一个静态方法 copy() 接收一个字符串 stack 作为参数并且返回一个复制的stack<br>
 * 注意:这个功能是拥有迭代器的作用的一个好例子,因为它允许开发出这么实用的功能而不需要改变基础的API.
 *
 * @author LeonChen
 * @since 12/31/19
 */
class e01_03_12 {
  ...
  public static void main(String[] args) {
    ...
    Stack<String> stack2 = Stack.copy(stack1);
  ...
  /**
   * The {@code Stack} class represents a last-in-first-out (LIFO) stack of generic items. It
