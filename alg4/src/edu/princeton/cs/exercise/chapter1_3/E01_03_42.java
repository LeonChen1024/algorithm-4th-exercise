 ...
 * </code> makes t a reference to a new and independent copy of the stack s.
 *
 * <p>复制一个 stack.创建一个新的构造器给一个链表实现的 Stack ,使得 <code>
 *     Stack<Item> t = new Stack<Item>(s);
 * </code> t 是指向一个独立的 stack s 的副本的引用.
 *
 * @author LeonChen
 * @since 2/3/20
 */
class E01_03_42 {
  ...
  public static void main(String[] args) {
    ...
    StdOut.println("s = " + s);
    StdOut.println("the copy of s =" + t);
    //    Queue<Integer> r = q;
