 ...
 * <p>
 * 软件缓存.修改 BST 使用一个实例变量来缓存最近访问的节点使得下一次 put() 或 get() 使用相同 key 的时候可以
 * 在常量级时间内返回(见练习 3.1.25)
 *
 * @author LeonChen
 * @since 4/24/21
 */
class E3_2_28 {
    ...
    /**
     * @formatter:off
     * 修改 get 和 put 方法,每次实际查找前先和cache 对比,相同则直接取出,不同则在找到元素后更新 cache
     * @formatter:on
     */
    ...
    public static class BST<Key extends Comparable<Key>, Value> {
         ...
         */
        public static void main(String[] args) {
            edu.princeton.cs.algs4.BST<String, Integer> st =
                    new edu.princeton.cs.algs4.BST<String, Integer>();
