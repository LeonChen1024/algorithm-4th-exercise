 ...
 *
 * <p>This implementation uses a binary heap. The <em>insert</em> and <em>delete-the-minimum</em>
 * operations take logarithmic amortized time. The <em>min</em>, <em>size</em>, and
