...
public class BinarySearch {
  ...
  public static void main(String[] args) {
    ...
    args = new String[] {"data/largeW.txt"};

    // TODO: 测试小数据

    //        args = new String[]{"tinyW.txt"};
    ...
    while (!StdIn.isEmpty()) {
      int key = StdIn.readInt();
      if (BinarySearch.bruteForceRank(key, whitelist) == -1) StdOut.println(key);
    }

    long end = System.currentTimeMillis();
    StdOut.println(end);
    StdOut.println("used time = " + (end - start));
  }
}
